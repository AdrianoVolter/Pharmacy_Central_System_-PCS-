...
const MedicamentosDepositos = connection.define(
  "medicamentos_depositos",
  {
    id_medicamentos: {
      type: INTEGER,
      references: {
...
Medicamentos.belongsToMany(Depositos, {
  through: MedicamentosDepositos,
  foreignKey: "id_medicamentos",
});
Depositos.belongsToMany(Medicamentos, {
  through: MedicamentosDepositos,
